...
<div id="div">
	<div style="display:inline-block; margin:20px;">關於 <strong><?php echo $title; ?></strong> 的問題...</div>
	...
	?>
		<div id="view_div">
			<div class="view_post">
				<span class="tag1"><a href='http://114.35.129.223/UniAsk/search/get/<?php echo $questions['catalog_school']; ?>'><?php echo $questions['catalog_school']; ?></a></span>
				<span class="tag2"><a href='http://114.35.129.223/UniAsk/search/get/<?php echo $questions['catalog_detail']; ?>'><?php echo $questions['catalog_detail']; ?></a></span><br/>
